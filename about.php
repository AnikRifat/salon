                ...
                <div class="col-lg-6">
                    <div class="about-item">
                        <div class="about-slider owl-carousel owl-theme">
                            ...
                            <div class="about-img">
                                <div class="top-border"></div>
                                <img src="assets/images/about/about-img2.jpg" alt="About" />
                                <div class="bottom-border bottom-border-color"></div>
                            </div>
                            <div class="about-img">
                                <div class="top-border"></div>
                                <img src="assets/images/about/about-img3.jpg" alt="About" />
                                <div class="bottom-border bottom-border-color"></div>
                            </div>
                        </div>
                    ...
                    <div class="about-content pl-20">
                        <div class="section-title">
                            ...
                            <p>
                                ...
                                and scrambled but also the leap into electronic typesetting.
                            </p>
                            <p>
                                Lorem Ipsum has been the industry standard dummy text ever
                                since the 1500s, when an unknown printer took a galley of type
                        ...
                        <a href="about.php" class="default-btn border-radius-5">Learn More <i
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <input type="text" id="datetimepicker" class="form-control" required
                                            data-error="Please Enter Date" placeholder=" Enter Date" />
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control" required
                                            data-error="Please Enter Address" placeholder="Address" />
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
